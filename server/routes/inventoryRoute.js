...
router.post("/add", authMiddleware, async (req, res) => {
  try {
    ...
    if (req.body.inventoryType === "in" && user.userType === "hospital") {
      throw new Error("This Email is not registerd as donar");
    }

    if (req.body.inventoryType === "out" && user.userType === "donar") {
      throw new Error("This Email is not registerd as hospital");
    }
